		...
		gl_panel_1.setHorizontalGroup(
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(lblFuerstenAnzahl, GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
					.addGap(18)
			...
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel_1.createSequentialGroup()
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_1.createSequentialGroup()
							.addContainerGap()
							.addComponent(lblWieVieleFrsten, GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE))
						.addGroup(gl_panel_1.createSequentialGroup()
							.addGap(27)
							.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE)
								.addComponent(btnFuerstenPlus, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
								.addComponent(btnFuerstenMinus, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblFuerstenAnzahl, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE))))
					.addContainerGap())
		);
		...
		gl_panel_2.setHorizontalGroup(
			gl_panel_2.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel_2.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(lblBauernAnzahl, GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
					.addGap(18)
			...
			gl_panel_2.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel_2.createSequentialGroup()
					.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_2.createSequentialGroup()
							.addContainerGap()
							.addComponent(lblWieVieleBauern, GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE))
						.addGroup(gl_panel_2.createSequentialGroup()
							.addGap(27)
							.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE)
								.addComponent(btnBauernPlus, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
								.addComponent(btnBauernMinus, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblBauernAnzahl, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE))))
					.addContainerGap())
		);
		...
		gl_panel_2_1.setHorizontalGroup(
			gl_panel_2_1.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel_2_1.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(lblKutscherAnzahl, GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
					.addGap(18)
			...
			gl_panel_2_1.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel_2_1.createSequentialGroup()
					.addGroup(gl_panel_2_1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_2_1.createSequentialGroup()
							.addContainerGap()
							.addComponent(lblWirdEsEinen, GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE))
						.addGroup(gl_panel_2_1.createSequentialGroup()
							.addGap(27)
							.addGroup(gl_panel_2_1.createParallelGroup(Alignment.BASELINE)
								.addComponent(btnKutscherPlus, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
								.addComponent(btnKutscherMinus, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblKutscherAnzahl, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE))))
					.addContainerGap())
		);
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGap(129)
					.addComponent(lblKoenigAnzahl, GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
					.addGap(91))
		);
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(27)
							.addComponent(lblKoenigAnzahl, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)))
					.addContainerGap())
		);
