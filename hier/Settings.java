			...
			gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup()
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(58)
							.addComponent(btnMinus, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(50)
							.addComponent(lblLoeschen, GroupLayout.PREFERRED_SIZE, 72, GroupLayout.PREFERRED_SIZE)))
					.addPreferredGap(ComponentPlacement.RELATED, 50, Short.MAX_VALUE)
					.addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, 213, GroupLayout.PREFERRED_SIZE)
					.addGap(43)
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(btnAddPlayer, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)
							.addGap(54))
						.addGroup(gl_panel.createSequentialGroup()
							.addComponent(lblHinzufgen)
							.addGap(33))))
				.addGroup(gl_panel.createSequentialGroup()
		...
		btnFertig.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(Main.playerList.size()>0) {
					Main.playerList.get(0).setKlasse("König");
					if(Main.playerList.size()>1) {
					for(int i = 1;i<= Main.fuersten;i++) {
						Main.playerList.get(i).setKlasse("Fürsten");
					}}
					if(Main.bauern>0) {
