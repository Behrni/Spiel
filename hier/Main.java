...
public class Main extends JFrame {
	...
	public Main() {
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
									...
									.addComponent(panel_2_1, GroupLayout.PREFERRED_SIZE, 166, GroupLayout.PREFERRED_SIZE))
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
								...
								.addComponent(panelBauern, GroupLayout.DEFAULT_SIZE, 452, Short.MAX_VALUE)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(pnlKutscher, GroupLayout.PREFERRED_SIZE, 452, GroupLayout.PREFERRED_SIZE)))
					.addGap(14)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
							...
							.addComponent(panel_3, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 233, Short.MAX_VALUE)))
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addComponent(panel_2_1, GroupLayout.PREFERRED_SIZE, 174, GroupLayout.PREFERRED_SIZE)
							.addGap(11)
							.addComponent(panel_2_2, GroupLayout.PREFERRED_SIZE, 174, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addComponent(panelFuersten, GroupLayout.PREFERRED_SIZE, 174, GroupLayout.PREFERRED_SIZE)
							.addGap(11)
							.addComponent(panelBauern, GroupLayout.PREFERRED_SIZE, 174, GroupLayout.PREFERRED_SIZE)))
					.addGap(9)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
		...
		JLabel lblKoenigPlayer= new JLabel("<html>"+"Name: "+ playerList.get(0).getName()+"<br/>Punkte:"+playerList.get(0).getPunkte()+"<html>");
		...
		JLabel lblFuersten[] = new JLabel[fuersten];
		for(int i = 0; i<lblFuersten.length;i++) {
			lblFuersten[i] = new JLabel("<html>"+"Name: "+ playerList.get(i+1).getName() + "<br/>Punkte:" + playerList.get(i+1).getPunkte()+ "<html>");
		...
		JLabel lblBauern[] = new JLabel[bauern];
		for(int i = 0; i<lblBauern.length;i++) {
			lblBauern[i] = new JLabel("<html>"+"Name: "+playerList.get(fuersten+1+i).getName()+"<br/>Punkte:"+playerList.get(fuersten+i+1).getPunkte() +"<html>");
		...
		JLabel lblKutschers[] = new JLabel[kutscher];
		for(int i = 0; i<lblKutschers.length;i++) {
			lblKutschers[i] = new JLabel("<html>"+"Name: "+ kutscherList.get(i).getName() + "<br/>Punkte:" + kutscherList.get(i).getPunkte()+ "<html>");
	...
	public static void updatePlayerLbl(JLabel lblKoenig, JLabel[] lblFuersten, JLabel[] lblBauern, JLabel[] lblKutschers) {
		...
		} else if(playerList.indexOf(selectedPlayer)>0 && playerList.indexOf(selectedPlayer)<lblFuersten.length+1) {
			selectedLabel = lblFuersten[playerList.indexOf(selectedPlayer)-1];
			selectedLabel.setBackground(Color.red);
			
		} else if(playerList.indexOf(selectedPlayer)>= lblFuersten.length+1 && playerList.indexOf(selectedPlayer)<lblFuersten.length+1+lblBauern.length){
			selectedLabel = lblBauern[playerList.indexOf(selectedPlayer)-1-lblFuersten.length];
			selectedLabel.setBackground(Color.red);
		}
		lblKoenig.setText("<html>"+"Name: "+ playerList.get(0).getName()+"<br/>Punkte:"+playerList.get(0).getPunkte()+"<html>");
		for(int i = 0; i<lblFuersten.length;i++) {
			lblFuersten[i].setText("<html>"+"Name: "+ playerList.get(i+1).getName()+"<br/>Punkte:"+playerList.get(i+1).getPunkte()+"<html>");
		}
		for(int i = 0; i<lblBauern.length;i++) {
			lblBauern[i].setText("<html>"+"Name: "+ playerList.get(lblFuersten.length+i+1).getName()+"<br/>Punkte:"+playerList.get(lblFuersten.length+i+1).getPunkte()+"<html>");
		}
		for(int i = 0;i<lblKutschers.length;i++) {
			lblKutschers[i].setText("<html>"+"Name: "+ kutscherList.get(i).getName()+"<br/>Punkte:"+kutscherList.get(i).getPunkte()+"<html>");
		}
	}
