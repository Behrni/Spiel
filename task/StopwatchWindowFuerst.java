...
public class StopwatchWindowFuerst extends JFrame {
	...
	public StopwatchWindowFuerst() {
		...
		JLabel lblNewLabel = new JLabel("Sehr geehrter F�rst " + Main.playerList.get(Main.counterFuersten).getName()
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
								.addComponent(btnShotFuerst, GroupLayout.PREFERRED_SIZE, 208,
										GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(ComponentPlacement.RELATED, 22, Short.MAX_VALUE).addComponent(
										btnAnsehenFuerst, GroupLayout.PREFERRED_SIZE, 208, GroupLayout.PREFERRED_SIZE))
		...
		btnAnsehenFuerst.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (Main.counterFuersten < Main.fuersten) {
					...
					System.out.println(Main.playerList.get(Main.counterFuersten).getPunkte());
					Main.timer.start();
					dispose();
					Main.counterFuersten = 0;
					Main.updatePlayerLbl(Main.lblKoenigPlayer, Main.lblFuersten, Main.lblBauern, Main.lblKutschers);
				}
			}
		});
